...
# 'https://api.qurancdn.com/api/qdc/verses/by_chapter/2?words=true&word_translation_language=bn&page=1&word_fields=verse_key,verse_id,page_number,location,text_uthmani,qpc_uthmani_hafs&mushaf=5'
...
do
    ...
    curl -s "https://api.qurancdn.com/api/qdc/verses/by_chapter/${i}?words=true&word_translation_language=en&page=${idx}&word_fields=verse_key,verse_id,page_number,location,text_uthmani,qpc_uthmani_hafs&mushaf=5"  > "$file"
